...
void preprocessImage(const std::string& image_path, float* gpu_input, const nvinfer1::Dims& dims) // example from https://learnopencv.com/how-to-run-inference-using-tensorrt-c-api/
{
...
void postprocessResults(float *gpu_output, const nvinfer1::Dims &dims, int batch_size) // example from https://learnopencv.com/how-to-run-inference-using-tensorrt-c-api/
{
    // get class names
